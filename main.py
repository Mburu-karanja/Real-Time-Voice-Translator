...
def open_about_page():      # about page
    ...
    github_link = ttk.Label(about_window, text="github.com/Mburu-karanja", underline=True, foreground="blue", cursor="hand2")
    github_link.bind("<Button-1>", lambda e: open_webpage("https://github.com/Mburu-karanja/"))
    github_link.pack()
